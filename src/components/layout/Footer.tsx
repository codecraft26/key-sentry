...
const footerNavigation = {
  ...
  social: [
    {
      name: 'Twitter',
      href: 'https://twitter.com/apiscape',
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/apiscape',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/apiscape',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/apiscape',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-muted-foreground">
              Secure API key management and analytics for modern applications. Empowering developers to build, secure, and monitor APIs with confidence.
            </p>
        ...
        <div className="mt-16 border-t border-muted pt-8 sm:mt-20 lg:mt-24">
          <div className="flex items-center justify-between">
            <p className="text-xs leading-5 text-muted-foreground">
              &copy; {new Date().getFullYear()} APIScape, Inc. All rights reserved.
            </p>
            <p className="text-xs leading-5 text-muted-foreground">
